...
thousands. This is the arithmetic behind the finding --- averaging one very
large locus over $\sim$$10^6$ variants destroys the signal, and the architecture
summary does not average it away.}
\end{figure}
